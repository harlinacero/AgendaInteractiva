<?php
	...
	if (!$conexion->error){
		...
		if ($_SESSION['agendaID']){
			...
			$add_evento = mysqli_query($conexion, "INSERT INTO agenda (title, start, start_hour, end, end_hour, allDay, fk_usuario) 
										VALUES ('$titulo','$fecha_inicio', '$hora_inicio', '$fecha_fin', '$hora_fin', $dia, $fk_usuario)") ;
